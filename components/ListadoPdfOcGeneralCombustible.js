...
const ListadoPdfOcGeneralCombustible = ({orden}) => {
    const {id, nombre, total, pedido, fecha, folio, descripcion,obra,emisor} = orden
                    ...
                    <div key={oc.id}>
                        <div className="m-auto">
                            ...
                            <div className="flex justify-center">
                                <Link href={`/ordenescombustible/${id}`} className="">
...
export default ListadoPdfOcGeneralCombustible
