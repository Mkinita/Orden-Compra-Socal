...
const ModalEquipo01 = () => {
  const { equipo, handleChangeModal, handleAgregarPedidoObra, pedido } = useCombustible();
      ...
      <div className="md:w-1/2">
        ...
        <di className="text-center">
          <button
            ...
            onClick={() => handleAgregarPedidoObra({ ...equipo, cantidad })}
          >
