...
const TableroTercero = ({ocpedidos}) => {
    ...
    <table class="w-full table-auto text-sm">
        ...
        <tbody>
            <tr class="hover:bg-grey-lighter">
                <td class="py-2 px-4 border-b border-grey-light w-1/3">{obra}</td>
                <td className="py-2 px-4 border-b border-grey-light w-1/3">{fechasolicitud}</td>
                <td className="py-2 px-4 border-b border-grey-light w-1/3">{formatearDinero (totaldubiva)}</td>
            </tr>
