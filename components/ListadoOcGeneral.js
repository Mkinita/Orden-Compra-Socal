            ...
            <tbody>
                {orden.map(oc => (
                    <tr key={oc.id}>
                        ...
                        <td className="border px-4 py-2 w-1/6">{fechasolicitud}</td>
                        ...
                        <td className="border px-4 py-2 w-1/12"><Link href={`/ordenes/${id}`} className=" flex justify-center items-center">
