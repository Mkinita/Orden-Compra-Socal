...
export default function Admin() {
    ...
    const { data, error, isLoading } = useSWR('/api/listado-ordenes-mayo',fetcher,{refreshInterval: 100} )
    ...
    const URL = '/api/listado-ordenes-mayo'
    ...
    return(
        <LayoutInicioAdminGeneral pagina={'Listado-OC'}>
            ...
            <h1 className="text-2xl font-black text-center"> Ordenes De Compra Mayo</h1>
