...
export default function Admin() {
  ...
  const fetcher = () => axios('/api/listado-ordenes-mayo').then(datos => datos.data)
  const { data, error} = useSWR('/api/listado-ordenes-mayo',fetcher,{refreshInterval: 100} )
  ...
  useEffect(() => {
    ...
    try {
      let url = '/api/listado-ordenes-mayo';
  ...
  return(
    <LayoutInicioAdminGeneral pagina={'Listado-OC'}>
      <h1 className="text-gray-500 text-lg font-semibold pb-8">Informe De Compras Por Obra Mayo 2023</h1>
