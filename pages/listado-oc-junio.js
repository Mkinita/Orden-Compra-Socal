...
export default function Admin() {
  ...
  const { data, error} = useSWR('/api/listado-ordenes-junio',fetcher,{refreshInterval: 100} )
  ...
  useEffect(() => {
    ...
    try {
      let url = '/api/listado-ordenes-junio';
  ...
  return(
    <LayoutInicioAdminGeneral pagina={'Listado-OC'}>
      <h1 className="text-gray-500 text-lg font-semibold pb-8">Informe De Compras Por Obra Junio 2023</h1>
