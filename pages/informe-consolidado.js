...
export default function Admin() {
  ...
  const fetcher = () => axios('/api/informe-consolidado').then(datos => datos.data)
  const { data, error} = useSWR('/api/informe-consolidado',fetcher,{refreshInterval: 100} )
  ...
  useEffect(() => {
    ...
    try {
      let url = '/api/informe-consolidado';
  ...
  return(
    <LayoutInicioAdminGeneral pagina={'Listado-OC'}>
      <h1 className="text-gray-500 text-lg font-semibold pb-8">Informe De Compras Por Obra Consolidado 2023</h1>
