...
export default function OrdenCompra() {
    ...
    const fetcher = () => axios('/api/ordenes-autorizadas-admin').then(datos => datos.data)
    const { data, error, isLoading } = useSWR('/api/ordenes-autorizadas-admin',fetcher,{refreshInterval: 100} )
