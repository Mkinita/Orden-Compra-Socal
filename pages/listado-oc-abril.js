...
export default function Admin() {
  ...
  const fetcher = () => axios('/api/listado-ordenes-abril').then(datos => datos.data)
  const { data, error} = useSWR('/api/listado-ordenes-abril',fetcher,{refreshInterval: 100} )
  ...
  useEffect(() => {
    ...
    try {
      let url = '/api/listado-ordenes-abril';
  ...
  return(
    <LayoutInicioAdminGeneral pagina={'Listado-OC'}>
      <h1 className="text-gray-500 text-lg font-semibold pb-8">Informe De Compras Por Obra Abril 2023</h1>
